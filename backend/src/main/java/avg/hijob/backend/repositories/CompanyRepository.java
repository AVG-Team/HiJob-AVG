...
public interface CompanyRepository extends JpaRepository<Company,String> {
    ...
    @Query("SELECT new avg.hijob.backend.responses.ResponseCompany(c.id,c.name,c.taxCode,c.field,c.address,c.province,c.registration_certificate,c.about,c.linkGoogleMap,c.user.id,c.createdAt,c.updatedAt,c.deletedAt, c.user.fullName) " +
            "FROM Company c " +
